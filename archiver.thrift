...
service Archiver extends module.Module {
     ...
     */
    types.TaskID convert_asset(1: types.VersionID document_id,
                               2: types.Mimetype mimetype,
                               3: map<string,string> conversion_info)
                       throws (1: errors.AssetNotFound asset_err,
                               2: errors.InvalidConversionInfo info_err,
                               4: errors.UnsupportedConversion converter_err,
                               3: errors.UnknownMimetype mime_err)
}
